	...
	<body >
		...
		<div id="setting" class="mui-page">
			...
			<div class="mui-navbar-inner mui-bar mui-bar-nav" style="background: #FFFFFF;">
				...
				<h1 class="mui-center mui-title ">用戶中心</h1>
			</div>
			<!--页面标题栏结束-->
            <?php session_start(); ?>
			<!--页面主内容区开始-->
					...
					<div class="mui-scroll" style="background-color: #FFFFFF">
						<ul class="mui-table-view mui-table-view-chevron">
							<li class="mui-table-view-cell">
                                ...
                                <a  class="mui-text-right" style="margin-right: -110px;" ><?php echo $_SESSION['userinfo']['name'] ?></a>
							</li>
							<li class="mui-table-view-cell">
								<span class="mui-icon mui-icon-locked"></span>
								<a  class="mui-text-right" style="margin-right: -110px;"  ><?php if($_SESSION['userinfo']['money']==null){echo 0.00; }else{echo $_SESSION['userinfo']['money'];}  ?>$</a>
							</li>
							<li class="mui-table-view-cell">
								<span class="mui-icon mui-icon-chatbubble"></span>
								<a  class="mui-text-right" style="margin-right: -110px;" ><?php echo $_SESSION['userinfo']['email'] ?></a>
							</li>
